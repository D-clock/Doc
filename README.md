...
- Android下的UI效果系列移除，接下来将这部分的文章和代码归档到 https://github.com/D-clock/AndroidSystemUiTraining

- Code系列，添加关于**烂代码的那些事[上]、[中]、[下]** 三篇

- 个人收藏系列，添加常用的**adb命令中文版和英文版** 两篇

- 移除多进程系列，新增系统Android下新增实现原理系列，收录**Binder解析和Window浅析** 两篇
